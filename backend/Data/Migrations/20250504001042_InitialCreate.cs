        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Latitude2 = table.Column<double>(type: "double precision", nullable: false),
                    Longitude2 = table.Column<double>(type: "double precision", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StartZoneId = table.Column<Guid>(type: "uuid", nullable: false),
                    EndZoneId = table.Column<Guid>(type: "uuid", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Rentals_Zones_EndZoneId",
                        column: x => x.EndZoneId,
                        principalTable: "Zones",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Rentals_Zones_StartZoneId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Rentals_EndZoneId",
                table: "Rentals",
                column: "EndZoneId");

            migrationBuilder.CreateIndex(
                name: "IX_Rentals_StartZoneId",
                table: "Rentals",
                column: "StartZoneId");
